...
public class GyroMechaPid implements LiveWindowSendable, MechaController {
    ...
    private class PIDTask extends TimerTask {
        ...
        private GyroMechaPid m_controller;

        public PIDTask(GyroMechaPid mechaPID) {
            if (mechaPID == null) {
     ...
     */
    public GyroMechaPid(double Kp, double Ki, double Kd, double Kf,
     ...
     * integral and differential terms. The default is 50ms.
     */
    public GyroMechaPid(double Kp, double Ki, double Kd,
                         PIDSource source, PIDOutput output, PIDOutput output2,
                         double period) {
