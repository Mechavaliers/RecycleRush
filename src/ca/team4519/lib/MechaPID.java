...
public class MechaPID implements LiveWindowSendable, MechaController {
    ...
    public MechaPID(double Kp, double Ki, double Kd, double Kf,
                         PIDSource source, PIDOutput output1, PIDOutput output2,
                         double period) {
    ...
    public MechaPID(double Kp, double Ki, double Kd,
                         PIDSource source, PIDOutput output1, PIDOutput output2,
                         double period) {
        this(Kp, Ki, Kd, 0.0, source, output1, output2, period);
    }
    ...
    public MechaPID(double Kp, double Ki, double Kd,
                         PIDSource source, PIDOutput output1, PIDOutput output2) {
        this(Kp, Ki, Kd, source, output1, output2, kDefaultPeriod);
    }
    ...
    public MechaPID(double Kp, double Ki, double Kd, double Kf,
                         PIDSource source, PIDOutput output1, PIDOutput output2) {
        this(Kp, Ki, Kd, Kf, source, output1, output2, kDefaultPeriod);
    }
    ...
    private void calculate() {
        ...
        synchronized (this) {
            ...
            if (m_pidOutput1 == null || m_pidOutput2 == null) {
                return;
            }
